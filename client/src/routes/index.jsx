...
import MemberRegistrationRejections from "../pages/MemberRegistrationRejections.jsx";
  ...
  createRoutesFromElements(
    <Route>
      ...
      >
        ...
        <Route path="/master/anggota/riwayat-penolakan" element={<MemberRegistrationRejections />} />
